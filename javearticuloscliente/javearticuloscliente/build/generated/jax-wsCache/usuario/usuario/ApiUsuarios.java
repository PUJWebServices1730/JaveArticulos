...
public interface ApiUsuarios {
    ...
    @RequestWrapper(localName = "getTipo", targetNamespace = "http://api/", className = "usuario.GetTipo")
    @ResponseWrapper(localName = "getTipoResponse", targetNamespace = "http://api/", className = "usuario.GetTipoResponse")
    @Action(input = "http://api/ApiUsuarios/getTipoRequest", output = "http://api/ApiUsuarios/getTipoResponse")
