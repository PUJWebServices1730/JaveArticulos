 ...
 * @author HP
 */
public class CalificarArticulo extends javax.swing.JFrame {
    
     private RestClient cliente;
    static String token;
    /**
     * Creates new form CalificarArticulo
     */
    public CalificarArticulo(String token) {
        
        cliente = new RestClient();
        this.token = token;
        initComponents();
        List<Revision> revis = cliente.revisiones(token);
        
        this.revisiones.setModel(new DefaultComboBoxModel(revis.toArray()));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Calificar Articulo");

        jLabel2.setText("Articulos: ");

        revisiones.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(revisiones, javax.swing.GroupLayout.PREFERRED_SIZE, 316, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(calificacion, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(0, 0, Short.MAX_VALUE))
    ...
    private void calificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calificarActionPerformed
        Revision rev = (Revision)revisiones.getSelectedItem();
        if(!calificacion.getText().equals("")){
            
            rev.setCalificacion(new Integer(this.calificacion.getText()));
            rev.setComentarios(this.comentarios.getText());
        }
        if(cliente.calificar(token, rev)!= null){
            JOptionPane.showMessageDialog(null, "Articulo calificado con exito");
...
this.setVisible(false);        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalificarArticulo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalificarArticulo(token).setVisible(true);
            }
        });
    }
